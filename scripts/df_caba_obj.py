...
###guardo el archivo
datasets.to_csv('caba_obj.csv', index=False)    

###abrir=pd.read_csv('caba_obj.csv', index_col='Archivo') Si voy a abrir, ya dejar marcada la columna 'Archivo' como índice
