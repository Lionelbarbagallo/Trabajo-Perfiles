# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 13:50:57 2019
...
###guardo el archivo
datasets.to_csv('fio_lab.csv', index=False) ###guardo el archivo

###abrir=pd.read_csv('fio_lab.csv', index_col='Archivo') Si voy a abrir, ya dejar marcada la columna 'Archivo' como índice